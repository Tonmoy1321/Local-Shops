...
public class SetupProfilePresenter {
    ...
    public SetupProfilePresenter(SetupProfileView view, Shop shop, DatabaseReference databaseReference) {
        this.view = view;
        this.shop = shop;
        this.databaseReference = databaseReference ; //FirebaseDatabase.getInstance().getReference().child("shops");
    }

    public boolean validateFormInputs(String userId, String fullName, String shopName,
                                      ...
                                      String phoneNumber, double radius, String shopType)
    {
        ...
        if(!shopType.equals("Bakery") && !shopType.equals("Conventional") && !shopType.equals("Stationary")){
            view.onProfileCreationFailed("wrong shop type");
            return false;
        }
