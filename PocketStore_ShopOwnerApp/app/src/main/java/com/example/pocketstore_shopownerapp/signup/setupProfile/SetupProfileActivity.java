    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(profilePresenter.validateFormInputs( FirebaseAuth.getInstance().getUid(), shopOwnerName.getText().toString().trim(),shopName.getText().toString().trim(),address.getText().toString().trim(),latitude,longitude,
                                                                    // 100 meters
