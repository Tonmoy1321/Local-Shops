...
public class SetupProfileActivity extends AppCompatActivity implements SetupProfileView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profilePresenter = new SetupProfilePresenter(this,new Customer(),FirebaseDatabase.getInstance().getReference());

        submitProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(profilePresenter.validateFormInputs(userId, userName.getText().toString(),userEmail.getText().toString(),
