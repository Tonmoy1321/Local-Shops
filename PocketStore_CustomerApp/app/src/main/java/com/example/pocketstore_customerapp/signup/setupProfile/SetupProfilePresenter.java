...
public class SetupProfilePresenter {
    ...
    public SetupProfilePresenter(SetupProfileView view, Customer customer, DatabaseReference databaseReference) {
        this.view = view;
        this.customer = customer;
        this.databaseReference = databaseReference ; //FirebaseDatabase.getInstance().getReference().child("customers");
    }

    public boolean validateFormInputs(String userId, String fullName, String email, String address, double latitude, double longitude, String phoneNumber){
